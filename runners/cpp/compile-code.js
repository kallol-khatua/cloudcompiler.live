...
const compileCode = (file_name, job_id) => {
    ...
    return new Promise(async (resolve, reject) => {
        ...
        // Get the executable name (program.cpp -> program)
        const execName = path.basename(file_name, ".cpp");

        // Step 1: Compile the C++ file
        const ptyProcess = pty.spawn("g++", [file_name, "-o", execName], {
            name: "xterm-color",
            cols: 100,
            rows: 30,
            cwd: jobsDir,
        ...
        ptyProcess.onExit(({ exitCode, signal }) => {
            ...
            if (exitCode == 0) {
                ...
                console.log("cpp code compiled successfully");


                resolve({ job_id, "message": "cpp code compiled successfully" });
